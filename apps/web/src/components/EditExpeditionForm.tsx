...
function hydrateStep(s: InitialStep): Step {
  return { ...s, showPicker: !!(s.lat && s.lng) };
}
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-6">
      ...
      <div>
        ...
        {initialCoverStorageKey && !coverPreview && (
          <img
            src={publicUrl(initialCoverStorageKey)}
            alt="Current cover"
          ...
          <div key={i} className="rounded-lg border p-4">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                >
                  {step.showPicker ? "Hide map" : "Edit location"}
                </button>
